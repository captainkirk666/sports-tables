...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* Print/export table — tightened vertical spacing for newspaper use */
  .export-header {
    display: flex; align-items: baseline; justify-content: space-between;
    border-bottom: 2px solid #e10600; padding-bottom: 0.4rem; margin-bottom: 0.75rem;
  }
  .export-header h1 { font-size: 1.2rem; margin: 0; }
  .export-meta { font-size: 0.7rem; color: #666; text-align: right; }
  ...
  .export-table td.numeric { text-align: right; font-variant-numeric: tabular-nums; }
  .export-truncated { font-size: 0.7rem; color: #999; margin-top: 0.3rem; font-style: italic; }
  .export-footer { margin-top: 0.6rem; font-size: 0.68rem; color: #999; }

  /* Hide everything except the print surface when actually printing */
  @media print {
    #site-nav, .site-nav, .hero, #table-tabs, .layout {
...
<div class="layout">
  <div class="panel">
    ...
    <div class="tier-tabs" style="margin-top:1.25rem;">
      <button class="tier-tab active" id="tab-default" onclick="selectTab('default')">Default</button>
      <button class="tier-tab" id="tab-preset" onclick="selectTab('preset')">Dynamic</button>
    ...
    <div class="colour-section">
      <h3>Colours</h3>
      <div id="colour-buttons" class="colour-buttons"></div>
    </div>
